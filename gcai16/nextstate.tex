...
%given Fig.~\ref{fig:examples/count_two}. 
%For example, by unrolling the loop of
% \verb'count_two' (Figure~\ref{fig:examples/count_two}) three times, we obtained the code on Figure~\ref{fig:examples/count_two_unrolled}.
...
assert(x + y == 3);
      \end{lstlisting}}
  \caption{The benchmark obtained by unrolling
