...
\def\paperSixContentsTitle{Checking Network Reachability Properties with\\Automated Reasoning in First-Order Logic}
\def\paperSixChapterTitle{Checking Network Reachability\\Properties with Automated Reasoning\\in First-Order Logic}
...
\def\paperFourPublication{Published in the \emph{Proceedings of the 8th International Joint Conference on Automated Reasoning}, pages \EK{XX--XX}. Springer, 2018.}
...
\def\paperFivePublication{Published in the \emph{Proceedings of the 6th Workshop on Practical Aspects of Automated Reasoning}, pages \EK{XX--XX}. Springer, 2018.}
