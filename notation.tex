...
\newcommand{\reserved}[1]{\textbf{#1}} % reserved words in algorithms
\newcommand{\ass}{$\coloneqq$}     % assignment operator
...
\newcommand{\itenll}[3]{\begin{aligned}[t]&\mathtt{if}\;{#1}\;\mathtt{then}\\[-0.2em]&\quad{#2}\\[-0.2em]&\mathtt{else}\;{#3}\end{aligned}}
