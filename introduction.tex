  ...
  \begin{equation*}
    \begin{aligned}
      ...
      \begin{aligned}
        ...
        &
        \begin{aligned}
          &\infer[,]{(L[r] \vee C_1 \vee C_2)\theta}{\underline{l \eql r} \vee C_1 & \underline{L[s]} \vee C_2}
          &\begin{array}{l}
        ...
        &
        \begin{aligned}
          &\infer[,]{(t[r] \otimes t' \vee C_1 \vee C_2)\theta}{\underline{l \eql r} \vee C_1 & \underline{t[s] \otimes t'} \vee C_2}
          &\begin{array}{l}
