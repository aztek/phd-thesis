...
Table~\ref{table:aws/results} presents the runtimes of Vampire on each of the problems. Dashes indicate the absense of a solution within the given time limit of 1 minute. These results were obtained on a MacBook Pro with a 2,9 GHz Intel Core i5 and 8 Gb RAM.
