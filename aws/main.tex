...
The complexity and potential impact of network verification makes it an attractive target for formal methods. 

Network reachability properties 

Check reachability properties of IP networks using symbolic model checking 

Nikolaj Bj\o{}rner et al.~\cite{DBLP:conf/icdcit/BjornerJ15} checked properties of Microsoft Azure networks  
...
Lisitsa \cite{DBLP:conf/atva/Lisitsa10}
}
%-------------------------------------------------------------------------------
